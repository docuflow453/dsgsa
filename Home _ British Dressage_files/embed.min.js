var ApplicationEmbed = ApplicationEmbed || function (w, u) {
    ...
    return {
        init: function () {
             ...
             const element = document.querySelectorAll('.tagshop-socialwall[data-wall-id="317303"]');
             const isTaggshp = document.querySelectorAll('.tagshop');
             
             if (element) {
                isTaggshp.forEach(el => {
            ...
            var containerTaggbox = document.getElementsByClassName('taggbox').length
            var tagEmbed = document.getElementsByClassName('tagembed-widget').length
            var container = socialwall && socialwall > 0 ? document.getElementsByClassName('taggbox-socialwall') : containerTaggbox ?  document.getElementsByClassName('taggbox') : tagEmbed ? document.getElementsByClassName('tagembed-widget') : document.getElementsByClassName('tagshop-socialwall');
