...
class ShowHoldingBodyBaseSchema(BaseModel):
...
class ShowHoldingBodyCreateSchema(ShowHoldingBodyBaseSchema):
    """Schema for creating a new Show Holding Body"""
    pass


class ShowHoldingBodyUpdateSchema(BaseModel):
    """Schema for updating an existing Show Holding Body (all fields optional)"""
...
class ShowHoldingBodySchema(BaseModel):
    """Complete schema for Show Holding Body response"""
    id: str
    name: str
...
class ShowHoldingBodyFilterSchema(FilterSchema):
    """Filter schema for listing Show Holding Bodies"""
